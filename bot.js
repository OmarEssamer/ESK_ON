...
ّّ~support| القسم الثاني  الدعم الفني و المساعدة
القسم الثالث مصمم البوت | ✠╠îKO╣๖ۣۜØƝ๖#7991
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 
`)
...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`~help By Master ON`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
if (message.content === ~'support') {
      message.author.send(' |https://discord.gg/2MsXKSm لـ أي استفسار').catch(e => console.log(e.stack));
...
if (message.content === '~invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/api/oauth2/authorize?client_id=549696459843305474&permissions=0&scope=bot ').catch(e => console.log(e.stack));
